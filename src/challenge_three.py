def list_uniqueness(the_list):
    ...
    Return a dictionary with two key-value pairs:
      ...
      2. The key 'number_of_unique_items' stores the number of unique items in the_list as its value.
    Arguments
    the_list: A list
    Examples
    l = [1, 2, 2, 4]
    ...
    print(dictionary['number_of_unique_items']) # prints 3
    '''
...
if __name__ == '__main__':
    ...
    print(dictionary['number_of_unique_items'])
